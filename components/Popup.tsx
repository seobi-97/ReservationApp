...
function Popup({ title, inputs, buttons, onSubmit }: PopupProps) {
  ...
  const [currentPickerInput, setCurrentPickerInput] =
    useState<SelectInputField | null>(null);
            ...
            <View key={input.id} style={styles.inputContainer}>
              ...
              {Platform.OS === "android" ? (
                ...
                <TouchableOpacity
                  ...
                  onPress={() => handlePickerOpen(input)}
                >
                  <Text
                    style={[
                      styles.pickerButtonText,
                      !input.value && styles.placeholderText,
                    ]}
                  >
                    {input.value || "선택하세요"}
                  </Text>
            ...
            <View key={input.id} style={styles.inputContainer}>
              ...
              {Platform.OS === "web" ? (
                <input
                  ...
                  type="date"
                  value={input.value.toISOString().split("T")[0]}
                  onChange={(e) => {
              ...
              {Platform.OS === "web" ? (
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <input
                    ...
                    type="time"
                    value={input.value.toTimeString().slice(0, 5)}
                    onChange={(e) => {
                ...
                <View style={styles.dateTimeContainer}>
                  ...
                  <Text style={styles.timeText}>
                    {input.value.toLocaleTimeString("ko-KR", {
                      hour: "2-digit",
                      minute: "2-digit",
                    })}
                  </Text>
                  {Platform.OS === "ios" ? (
                    <View style={{ flexDirection: "row" }}>
                      <DateTimePicker
                        ...
                        style={[styles.dateTimePicker, { flex: 1 }]}
                      />
                      <DateTimePicker
                        value={input.value}
                        mode="time"
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.pickerModal}>
            ...
            <Picker
              ...
              onValueChange={(value) => setTempPickerValue(value)}
